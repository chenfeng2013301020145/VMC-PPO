...
def train(epochs=100, Ops_args=dict(), Ham_args=dict(), n_sample=80, init_type='rand', n_optimize=10,
    ...
    scheduler = torch.optim.lr_scheduler.MultiStepLR(optimizer, [epochs-100], gamma=1)
    ...
    for epoch in range(epochs):
        ...
        DFS, ME, CME, clipfrac, AvgE, AvgE2, idx = update(set_op_steps, preload, batch, sd, 
